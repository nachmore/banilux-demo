...
export class Services extends Stack {
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        const repositoryURI = "public.ecr.aws/one-Banilux";
...
//                assumedBy: eksFederatedPrincipal,
        ...
        this.createSsmParameters(new Map(Object.entries({
            '/banilux/trafficdelaytime':"1",
            '/banilux/rumscript': " ",
            '/banilux/petadoptionsstepfnarn': petAdoptionsStepFn.stepFn.stateMachineArn,
            '/banilux/updateadoptionstatusurl': statusUpdaterService.api.url,
            '/banilux/queueurl': sqsQueue.queueUrl,
            '/banilux/snsarn': topic_petadoption.topicArn,
            '/banilux/dynamodbtablename': dynamodb_petadoption.tableName,
            '/banilux/s3bucketname': s3_observabilitypetadoptions.bucketName,
            '/banilux/searchapiurl': `http://${searchService.service.loadBalancer.loadBalancerDnsName}/api/search?`,
            '/banilux/searchimage': searchService.container.imageName,
            '/banilux/petlistadoptionsurl': `http://${listAdoptionsService.service.loadBalancer.loadBalancerDnsName}/api/adoptionlist/`,
            '/banilux/petlistadoptionsmetricsurl': `http://${listAdoptionsService.service.loadBalancer.loadBalancerDnsName}/metrics`,
            '/banilux/paymentapiurl': `http://${payForAdoptionService.service.loadBalancer.loadBalancerDnsName}/api/home/completeadoption`,
            '/banilux/payforadoptionmetricsurl': `http://${payForAdoptionService.service.loadBalancer.loadBalancerDnsName}/metrics`,
            '/banilux/cleanupadoptionsurl': `http://${payForAdoptionService.service.loadBalancer.loadBalancerDnsName}/api/home/cleanupadoptions`,
            '/banilux/petsearch-collector-manual-config': readFileSync("./resources/collector/ecs-xray-manual.yaml", "utf8"),
