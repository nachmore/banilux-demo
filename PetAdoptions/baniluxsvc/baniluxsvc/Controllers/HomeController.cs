...
using Amazon;
using BaniluxService.ViewModels;
...
namespace BaniluxService.Controllers
{
    public class HomeController : Controller
    {
        ...
        private static readonly Counter PetSearchCount =
            Metrics.CreateCounter("baniluxsvc_petsearches_total", "Count the number of searches performed");

        //Prometheus metric to count the number of puppy searches performed
        private static readonly Counter PuppySearchCount =
            Metrics.CreateCounter("baniluxsvc_pet_puppy_searches_total", "Count the number of puppy searches performed");

        //Prometheus metric to count the number of kitten searches performed
        private static readonly Counter KittenSearchCount =
            Metrics.CreateCounter("baniluxsvc_pet_kitten_searches_total", "Count the number of kitten searches performed");

        //Prometheus metric to count the number of bunny searches performed
        private static readonly Counter BunnySearchCount =
            Metrics.CreateCounter("baniluxsvc_pet_bunny_searches_total", "Count the number of bunny searches performed");

        private static readonly Gauge PetsWaitingForAdoption = Metrics
            .CreateGauge("baniluxsvc_pets_waiting_for_adoption", "Number of pets waiting for adoption.");
